...
{as_host = "autoscaling.amazonaws.com" :: string(),
  ...
  elb_host = "elasticloadbalancing.amazonaws.com" ::
  string(),
  ...
  emr_host = "elasticmapreduce.us-east-1.amazonaws.com" ::
  string(),
  ...
  ddb_retry = fun erlcloud_ddb_impl:retry/1 ::
  erlcloud_ddb_impl:retry_fun(),
  ...
  lambda_host = "lambda.us-east-1.amazonaws.com" ::
  string(),
  lambda_port = 443 :: non_neg_integer(),
  states_scheme = "https://" :: string(),
  states_host = "states.us-east-1.amazonaws.com" ::
  string(),
  states_port = 443 :: non_neg_integer(),
  redshift_scheme = "https://" :: string(),
  redshift_host = "redshift.us-east-1.amazonaws.com" ::
  string(),
  redshift_port = 443 :: non_neg_integer(),
  kinesis_scheme = "https://" :: string(),
  kinesis_host = "kinesis.us-east-1.amazonaws.com" ::
  string(),
  kinesis_port = 80 :: non_neg_integer(),
  kinesis_retry = fun erlcloud_kinesis_impl:retry/2 ::
  erlcloud_kinesis_impl:retry_fun(),
  ...
  athena_host = "athena.us-east-1.amazonaws.com" ::
  string(),
  ...
  cloudsearch_host = "cloudsearch.us-east-1.amazonaws.com"
  :: string(),
  ...
  guardduty_host = "guardduty.us-east-1.amazonaws.com" ::
  string(),
  ...
  config_host = "config.us-east-1.amazonaws.com" ::
  string(),
  ...
  retry = fun erlcloud_retry:no_retry/1 ::
  erlcloud_retry:retry_fun(),
  retry_response_type =
  fun erlcloud_retry:only_http_errors/1
  :: erlcloud_retry:response_type_fun(),
  retry_num = 10 :: non_neg_integer(),
  assume_role = #aws_assume_role{} :: aws_assume_role(),
